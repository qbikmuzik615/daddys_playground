...
const generateWordProblem = (difficulty: number) => {
  ...
  const templates = [
    {
      story: `You have ${num1} baskets. Each basket has ${num2} apples. How many apples do you have in total?`,
    ...
    {
      story: `You baked ${num1} trays of cookies. Each tray has ${num2} cookies. How many cookies did you bake in total?`,
    ...
    <div className="text-center">
      ...
      <div className="mb-6">
        <p className="text-lg mb-2">
          <span className="font-bold">{player.name}</span>, solve this word problem:
        </p>
